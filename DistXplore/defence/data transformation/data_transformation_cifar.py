...
for truth in range(10):
    ...
    for target in target_list:
        # adv_data = np.load("D:/distribution-aware-data/defesnse crashes/cifar10/mmd/seed_v1/data_%s_%s.npy"%(truth, target))
        # adv_label = np.load("D:/distribution-aware-data/defesnse crashes/cifar10/mmd/seed_v1/ground_truth_%s_%s.npy"%(truth, target))
        adv_data = np.load("D:/distribution-aware-data/defesnse crashes/cifar10/nbc/data.npy")
        adv_label = np.load("D:/distribution-aware-data/defesnse crashes/cifar10/nbc/ground_truth.npy")
