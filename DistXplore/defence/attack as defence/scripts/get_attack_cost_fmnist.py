...
if __name__ == "__main__":
    ...
    for gtruth in [args.select_truth]:
        ...
        for target in target_list:
            ...
            x_adv = np.load("/data/distribution-aware-data/defesnse crashes/fmnist/mmd/seed_v1/data_%s_%s.npy"%(gtruth, target))
            y_adv = np.load("/data/distribution-aware-data/defesnse crashes/fmnist/mmd/seed_v1/ground_truth_%s_%s.npy"%(gtruth, target))
