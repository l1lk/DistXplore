...
class cifar10vgg:
    def __init__(self, train=False):
        ...
        if train:
            ...
            self.model.load_weights('model_weights/vgg16_cifar_weights.h5')
    ...
    def train(self, model):
        ...
        save_dir = "/data/wlt/vgg_saved_models_1"
        model_name = 'cifar10_vgg_model.{epoch:03d}.h5' 
        ...
        historytemp = model.fit_generator(datagen.flow(x_train, y_train,
                            ...
                            epochs=maxepoches,
                            validation_data=(x_test, y_test),callbacks=[check_point, reduce_lr],verbose=2)
