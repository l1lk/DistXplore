...
def Vae_CIFAR(input_tensor=None, train=False):
    np.random.seed(0)
    ...
    vae = Model(input_tensor, outputs, name='vae_cifar')
    #vae.summary()
    ...
    if train:
        ...
        # save model
        vae.save_weights('./vae_cifar_test_svhn_pre.h5')
    else:
