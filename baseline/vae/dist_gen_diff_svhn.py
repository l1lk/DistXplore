...
import tqdm
from get_model import svhn_vgg16, svhn_resnet20
random.seed(3)
...
if args.weight_vae == 0:
    ...
    output_directory = './vae_svhn_seed2/set' + str(args.run_idx) + '/'
...
vae = Vae_SVHN(input_tensor=model.input)
...
seeds = np.load("single_cluster_seeds/svhn/training_100_v2/class_%s_seed.npy"%seed_index)
...
seeds = svhn_preprocessing(seeds)
