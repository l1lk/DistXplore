...
class Fuzzer(object):
    ...
    def loop(self, iterations, model, args, g_ptr):
        """Fuzzes a machine learning model in a loop, making *iterations* steps."""
        iteration = 0
        while True:
            print("_____________________",iteration)
            ...
            # print("test", parent.fname)
            # print("parent: ", np.load(parent.fname)[0])
            ...
            # print("test",mutated_data_batches)
            coverage_batches, metadata_batches, origin_imgs = self.fetch_function(
            ...
            if coverage_batches is not None and len(coverage_batches) > 0:
                ...
                mutated_coverage_list = self.coverage_function(coverage_batches,model, args, origin_imgs)
